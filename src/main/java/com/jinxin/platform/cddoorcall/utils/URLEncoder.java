 ...
 * @Author: chenyinlong
 * @Description:
 * @Date: Create in 15:50 2020/4/22
 */
public class URLEncoder {
    ...
    public static void main(String[] args) {
        ...
        jsonObject.put("p2","123.1.22.1");
        jsonObject.put("p3","123");
        jsonObject.put("p4","123");
        System.out.println(jsonObject.toJSONString());
        System.out.println(encodeURIComponent(jsonObject.toJSONString()));
    }
}
